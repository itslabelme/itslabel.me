    ...
    r = jQuery, s = "." + (o = i = "metisMenu"), a = r.fn[i], l = {
        ...
        return a.prototype.init = function() {
            ...
            r(this._element).find(this._config.parentTrigger + "." + this._config.activeClass).has(this._config.subMenu).children(this._config.subMenu).attr("aria-expanded", !0).addClass(this._config.collapseClass + " " + this._config.collapseInClass), r(this._element).find(this._config.parentTrigger).not("." + this._config.activeClass).has(this._config.subMenu).children(this._config.subMenu).attr("aria-expanded", !1).addClass(this._config.collapseClass), r(this._element).find(this._config.parentTrigger).has(this._config.subMenu).children(this._config.triggerElement).on(h.CLICK_DATA_API, function(t) {
                var e = r(this),
                    i = e.parent(n._config.parentTrigger),
        ...
        slimScroll: function(x) {
            ...
            return this.each(function() {
                ...
                function s(t, e, i) {
                    ...
                    e && (e = parseInt(m.css("top")) + t * parseInt(_.wheelStep) / 100 * m.outerHeight(), e = Math.min(Math.max(e, 0), s), e = 0 < t ? Math.ceil(e) : Math.floor(e), m.css({
                        top: e + "px"
                    })), e = (u = parseInt(m.css("top")) / (f.outerHeight() - m.outerHeight())) * (f[0].scrollHeight - f.outerHeight()), i && (t = (e = t) / f[0].scrollHeight * f.outerHeight(), t = Math.min(Math.max(t, 0), s), m.css({
                        top: t + "px"
                    })), f.scrollTop(e), f.trigger("slimscrolling", ~~e), a(), n()
                }

                function i() {
                    p = Math.max(f.outerHeight() / f[0].scrollHeight * f.outerHeight(), 30), m.css({
                        height: p + "px"
                    });
                ...
                var r, o, l, h, c, p, u, d, g = !1,
                    f = w(this);
                if (f.parent().hasClass(_.wrapperClass)) {
                    var v = f.scrollTop(),
                        m = f.siblings("." + _.barClass),
                        y = f.siblings("." + _.railClass);
                    if (i(), w.isPlainObject(x)) {
                        ...
                        if ("scrollTo" in x) v = parseInt(_.scrollTo);
                        else if ("scrollBy" in x) v += parseInt(_.scrollBy);
                        else if ("destroy" in x) return m.remove(), y.remove(), void f.unwrap();
                        s(v, !1, !0)
                    }
                    ...
                    }), i(), "bottom" === _.start ? (m.css({
                        top: f.outerHeight() - m.outerHeight()
                    }), s(0, !0)) : "top" !== _.start && (s(w(_.start).position().top, null, !0), _.alwaysVisible || m.hide()), window.addEventListener ? (this.addEventListener("DOMMouseScroll", e, !1), this.addEventListener("mousewheel", e, !1)) : document.attachEvent("onmousewheel", e)
                }
            }), this
        }
    }), w.fn.extend({
        slimscroll: w.fn.slimScroll
    })
}(jQuery),
function(a) {
    "use strict";
    ...
    n.defaults = {
        ...
        var r = this.$element,
            ...
            u = parseInt(r.attr("aria-valuemin")) || 0,
            d = parseInt(r.attr("aria-valuemax")) || 100,
...
function(k, B, N) {
    ...
    t = function(z) {
        "use strict";
        var t, e, m, E, x, F, W, L, c, w, i, n, p, D, u, s, a, A, O, o, r, l, h, _, d, g, f, v, y, b = {},
            C = 0;
        t = function() {
            return {
                common: {
            ...
            updateDisplay: function() {
                var t, e, i, s, a = this.splist,
                    n = a.length,
                    r = !1,
                    o = this.$canvas.offset(),
                    l = this.currentPageX - o.left,
                    h = this.currentPageY - o.top;
                if (this.over) {
            ...
            return this.each(function() {
                var t, e, o = new z.fn.sparkline.options(this, i),
                    l = z(this);
                if (t = function() {
                        var t, e, i, s, a, n, r;
                    ...
                    if (!o.get("composite") && z.data(this, "_jqs_pending"))
            ...
            getTagSetting: function(t) {
                ...
                if (this.tagValCache.hasOwnProperty(t)) e = this.tagValCache.key;
                    ...
                    if ((e = this.tag.getAttribute(n + t)) === N || null === e) e = b;
                    else if ("[" === e.substr(0, 1))
                        for (i = (e = e.substr(1, e.length - 2).split(",")).length; i--;) e[i] = F(e[i].replace(/(^\s*)|(\s*$)/g, ""));
                    else if ("{" === e.substr(0, 1))
                        for (s = e.substr(1, e.length - 2).split(","), e = {}, i = s.length; i--;) e[(a = s[i].split(":", 2))[0].replace(/(^\s*)|(\s*$)/g, "")] = F(a[1].replace(/(^\s*)|(\s*$)/g, ""));
                    else e = F(e);
            ...
            getCurrentRegionTooltip: function() {
                var t, e, i, s, a, n, r, o, l, h, c, p, u, d, g = this.options,
                    f = "",
                    v = [];
                ...
                for (i = e.length, u = t.length, n = 0; n < i; n++)
                    for ("string" == typeof(p = e[n]) && (p = new m(p)), s = p.fclass || "jqsfield", d = 0; d < u; d++) t[d].isNull && g.get("tooltipSkipNull") || (z.extend(t[d], {
            ...
            calcHighlightColor: function(t, e) {
                var i, s, a, n, r = e.get("highlightColor"),
            ...
            getRegion: function(t, e, i) {
                ...
                for (s = a.length; s--;)
                    if (null !== a[s] && e >= a[s][0] && e <= a[s][1]) return a[s][2];
                return N
            },
            getCurrentRegionFields: function() {
            ...
            render: function() {
                ...
                if (A._super.render.call(this) && (this.scanValues(), this.processRangeOptions(), _ = this.xvalues, w = this.yvalues, this.yminmax.length && !(this.yvalues.length < 2))) {
                    ...
                    if (I && k.get("valueSpots"))
                        for ((y = k.get("valueSpots")).get === N && (y = new D(y)), C = 0; C < g; C++)(x = y.get(w[C])) && S.drawCircle(a + B.round((_[C] - this.minx) * (R / t)), s + B.round(M - M * ((w[C] - this.miny) / e)), I, N, x).append();
            ...
            init: function(t, e, i, s, a) {
                var n, r, o, l, h, c, p, u, d, g, f, v, m, y, b, x, _, w, C, k, S, R = parseInt(i.get("barWidth"), 10),
                    ...
                    T = i.get("chartRangeMin"),
                    I = i.get("chartRangeMax"),
                ...
                for (c = 0, p = e.length; c < p; c++)
                    if (b)
                        for (x = e[c], e[c] = C = [], q[c] = 0, l[c] = j[c] = 0, _ = 0, w = x.length; _ < w; _++) null !== (k = C[_] = H ? E(x[_], m, y) : x[_]) && (0 < k && (q[c] += k), A < 0 && 0 < P ? k < 0 ? j[c] += B.abs(k) : l[c] += k : l[c] += B.abs(k - (k < 0 ? P : A)), h.push(k));
                    else k = H ? E(e[c], m, y) : e[c], null !== (k = e[c] = F(k)) && h.push(k);
            ...
            calcColor: function(t, e, i) {
                var s, a, n = this.colorMapByIndex,
            ...
            renderRegion: function(t, e) {
                var i, s, a, n, r, o, l, h, c, p, u = this.values[t],
                    d = this.options,
                    g = this.xaxisOffset,
                    f = [],
                    v = this.range,
            ...
            init: function(t, e, i, s, a) {
                var n = parseInt(i.get("barWidth"), 10),
                    r = parseInt(i.get("barSpacing"), 10);
            ...
            renderRange: function(t, e) {
                var i = this.values[t],
                    s = B.round(this.canvasWidth * ((i - this.min) / this.range)),
            ...
            renderPerformance: function(t) {
                var e = this.values[1],
                    i = B.round(this.canvasWidth * ((e - this.min) / this.range)),
            ...
            renderTarget: function(t) {
                var e = this.values[0],
                    ...
                    s = B.round(.1 * this.canvasHeight),
                    a = this.canvasHeight - 2 * s,
            ...
            init: function(t, e, i, s, a) {
                var n, r = 0;
                if (h._super.init.call(this, t, e, i, s, a), this.shapes = {}, this.valueShapes = {}, this.values = e = z.map(e, Number), "auto" === i.get("width") && (this.width = this.height), 0 < e.length)
            ...
            render: function() {
                var t, e, i, s, a, n, r, o, l, h, c, p = this.target,
                    u = this.values,
                    d = u.length,
                    g = this.options,
                    f = this.canvasWidth,
                    ...
                    y = g.get("chartRangeMax") === N ? B.max.apply(B, u) : g.get("chartRangeMax"),
                    b = 0;
                if (_._super.render.call(this)) {
                    if (g.get("raw")) g.get("showOutliers") && 5 < u.length ? (e = u[0], t = u[1], s = u[2], a = u[3], n = u[4], r = u[5], o = u[6]) : (t = u[0], s = u[1], a = u[2], n = u[3], r = u[4]);
...
var pJS = function(t, e) {
    ...
    e && Object.deepExtend(d, e), d.tmp.obj = {
        ...
        if (this.radius = (d.particles.size.random ? Math.random() : 1) * d.particles.size.value, d.particles.size.anim.enable && (this.size_status = !1, this.vs = d.particles.size.anim.speed / 100, d.particles.size.anim.sync || (this.vs = this.vs * Math.random())), this.x = i ? i.x : Math.random() * d.canvas.w, this.y = i ? i.y : Math.random() * d.canvas.h, this.x > d.canvas.w - 2 * this.radius ? this.x = this.x - this.radius : this.x < 2 * this.radius && (this.x = this.x + this.radius), this.y > d.canvas.h - 2 * this.radius ? this.y = this.y - this.radius : this.y < 2 * this.radius && (this.y = this.y + this.radius), d.particles.move.bounce && d.fn.vendors.checkOverlap(this, i), this.color = {}, "object" == typeof t.value)
        ...
        else s = "hsla(" + t.color.hsl.h + "," + t.color.hsl.s + "%," + t.color.hsl.l + "%," + i + ")";
        switch (d.canvas.ctx.fillStyle = s, d.canvas.ctx.beginPath(), t.shape) {
            ...
            case "star":
                ...
                break;
            case "image":
                if ("svg" == d.tmp.img_type) var a = t.img.obj;
                else a = d.tmp.img_obj;
        ...
        if (Math.sqrt(i * i + s * s) <= d.particles.line_linked.distance) {
            var a = i / (1e3 * d.particles.move.attract.rotateX),
                n = s / (1e3 * d.particles.move.attract.rotateY);
        ...
        if (d.interactivity.events.onhover.enable && isInArray("bubble", d.interactivity.events.onhover.mode)) {
            var i = o.x - d.interactivity.mouse.pos_x,
                s = o.y - d.interactivity.mouse.pos_y,
                ...
                if (0 <= a && "mousemove" == d.interactivity.status) {
                    if (d.interactivity.modes.bubble.size != d.particles.size.value)
                        if (d.interactivity.modes.bubble.size > d.particles.size.value) {
                            ...
                            var n = o.radius - d.interactivity.modes.bubble.size,
                                r = o.radius - n * a;
            ...
            if (d.tmp.bubble_clicking) {
                ...
                var h = Math.sqrt(i * i + s * s),
                    c = ((new Date).getTime() - d.interactivity.mouse.click_time) / 1e3;
        ...
        if (d.interactivity.events.onhover.enable && isInArray("repulse", d.interactivity.events.onhover.mode) && "mousemove" == d.interactivity.status) {
            var t = s.x - d.interactivity.mouse.pos_x,
                e = s.y - d.interactivity.mouse.pos_y,
                i = Math.sqrt(t * t + e * e),
                a = t / i,
                n = e / i,
            ...
            if (d.tmp.repulse_finish || (d.tmp.repulse_count++, d.tmp.repulse_count == d.particles.array.length && (d.tmp.repulse_finish = !0)), d.tmp.repulse_clicking) {
                var l = Math.pow(d.interactivity.modes.repulse.distance / 6, 3),
                    h = d.interactivity.mouse.click_pos_x - s.x,
                    c = d.interactivity.mouse.click_pos_y - s.y,
                    p = h * h + c * c,
                    u = -l / p * 1;
                p <= l && function() {
        ...
        if (d.interactivity.events.onhover.enable && "mousemove" == d.interactivity.status) {
            var e = t.x - d.interactivity.mouse.pos_x,
                i = t.y - d.interactivity.mouse.pos_y,
                s = Math.sqrt(e * e + i * i);
        ...
        var t = d.tmp.source_svg.replace(/#([0-9A-F]{3,6})/gi, function(t, e, i, s) {
                if (n.color.rgb) var a = "rgba(" + n.color.rgb.r + "," + n.color.rgb.g + "," + n.color.rgb.b + "," + n.opacity + ")";
                else a = "hsla(" + n.color.hsl.h + "," + n.color.hsl.s + "%," + n.color.hsl.l + "%," + n.opacity + ")";
                return a
            }),
            e = new Blob([t], {
...
Object.deepExtend = function(t, e) {
    ...
    if (a.length)
        for (; 0 < a.length;) i.removeChild(a[0]);
