    ...
    def controller_configuration
      {
        ...
        partials_path: {
          new_form: "/admin/admin_users/form/form",
          edit_form: "/admin/admin_users/form/form",
          show: "/admin/admin_users/show",
          table: "/admin/admin_users/index/table",
          row: "/admin/admin_users/index/row",
          new_controls: "/admin/admin_users/form/controls",
          edit_controls: "/admin/admin_users/form/controls",
          filters: "/admin/admin_users/index/filters"
        }
      }
    end
