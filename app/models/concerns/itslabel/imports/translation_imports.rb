module Itslabel::Imports::TranslationImports
  ...
  class_methods do
    ...
    def save_row_data(hsh)
      ...
      translation = Translation.where(input_phrase: input_phrase, output_phrase: output_phrase, input_language: input_language, output_language: output_language, admin_user_id: admin_user.id).first || Translation.new
          
      translation.admin_user_id = admin_user.id
